...
public class SpringKafkaSenderTest {
    ...
    public void setUp() throws Exception {
        ...
        DefaultKafkaConsumerFactory<String, MessageDTO> consumerFactory =
                new DefaultKafkaConsumerFactory<String, MessageDTO>(
                        consumerProperties, new StringDeserializer(), new JsonDeserializer<>(MessageDTO.class));
        ...
        container = new KafkaMessageListenerContainer<String, MessageDTO>(consumerFactory,
                containerProperties);
        ...
        container
                .setupMessageListener(new MessageListener<String, MessageDTO>() {
                    @Override
    ...
    public void testSend() throws InterruptedException {
        ...
        sender.send(messageDTO, SENDER_TOPIC);

        // check that the message was received
        ConsumerRecord<String, MessageDTO> received =
                records.poll(10, TimeUnit.SECONDS);
        // Hamcrest Matchers to check the value
        LOGGER.info("received: " + received.value().toString());
        assertThat(received, hasValue(messageDTO));
